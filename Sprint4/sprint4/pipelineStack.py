...
from sprint4.pipelineStage import SP4Stage as stage_


class SP4PipelineStack(Stack):
    '''
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        synthesizer = pipeline_.ShellStep("Synth", 
                commands = ["cd faraz2022skipq/Sprint4/",
                            "npm install -g aws-cdk",
                            "pip install -r requirements.txt", "cdk synth"],
                input = source_directory,
                primary_output_directory = "faraz2022skipq/Sprint4/cdk.out")
